...
with con:
    ...
    cur.execute("INSERT INTO Participant (Participant_id, Name, Age, Gender) VALUES (5, 'John', 21, 'Male')")
    cur.execute("INSERT INTO Participant (Participant_id, Name, Age, Gender) VALUES (6, 'Mary', 21, 'Female')")
    cur.execute("INSERT INTO Participant (Participant_id, Name, Age, Gender) VALUES (7, 'Jeffrey', 21, 'Male')")
    cur.execute("INSERT INTO Participant (Participant_id, Name, Age, Gender) VALUES (8, 'Sam', 21, 'Male')")
